 ...
 */
@WebServlet("/applicant/applicantBoardList")
public class ApplicantBoardList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// 3. view 처리
			request.getRequestDispatcher("/WEB-INF/views/applicant/applicantBoardList.jsp").forward(request, response);
